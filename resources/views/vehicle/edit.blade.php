                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('vehicle.update',$vehicle) }}" method="POST">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" placeholder="honda.."
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="plate" placeholder="N 1234 .."
                        ...
                        <div class="form-group">
                            <label>Type</label>
                            <input type="text" name="type" placeholder="car, bus, truck..."
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="fuel_per_km" placeholder="2"
                                value="{{ old('fuel_per_km',$vehicle->fuel_per_km) }}"
